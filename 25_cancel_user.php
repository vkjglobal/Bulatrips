...
?>
   ...
   //echo $pre_ticket_status;
     if($pre_booking_status ==  trim("Booked")){ 
       //echo "KK";
       if(($pre_ticket_status  !=  trim("Ticketed"))  &&  ($pre_ticket_status  !=  trim("TktInProcess"))) {
       //      
           //   echo "uu";
            ...
            <div class="row my-4">
                <div class="col-12 text-center">
                    ...
                    -->
                     ...
                     <button type="button" class="btn btn-typ3 mb-3" id="precancel" onclick="precancelApi()" >Cancel Your Flight</button>
                     <?php } else { ?>
                                          <button type="button" class="btn btn-typ3 mb-3">Cancel Your Flight</button>
                                         <?php } ?>
                      <!-- pre ticket booking cancel ends  -->
