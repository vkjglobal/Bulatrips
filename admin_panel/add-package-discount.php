                    ...
                    <div class="col-12">
                        <form class="" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row" style="display: flex;">
                                <div class="col-12">
                                    <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">Add Package Discount</strong>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" id="category" name="position">
                                                <option value="">Select.....</option>
                                ...
                                <input type="submit" name="submit" value="submit" id="submit" class="btn btn-primary btn-typ3">
                                    ...
                                    <a href="package-discount-list.php" class="btn btn-primary btn-typ3 ms-2">Cancel</a>   
                                </div>
                            </div>
                        </form>
                    </div>
