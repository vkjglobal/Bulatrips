...
?>
 <div class="container-fluid pt-4 px-4">
                ...
                <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block text-left">Flight Booking List of Agents</strong>    
                            ...
                            <td><?php echo $row['email'] ?></td>
                             ...
                             <td><?php echo $row['air_trip_type'] ?></td>
                              <td><span class="badge bg-success"><?php echo $row['booking_status'] ?></span></td>
                               ...
                               <td><a href="flight-details-admin.php?id=<?php echo $row['bookingId']; ?>"><i class="fa fa-eye">&nbsp;</i></a></td>
...
?>
        ...
        <script>
            ...
            document.getElementById('download').addEventListener('click', function() {
                ...
                // Add title
                doc.setFontSize(18);
                doc.text('Agents Book - Flight List', 14, 22);
                ...
                // });
                 ...
                 $('#myTable thead tr th').each(function(index) {
                    if (index !== 8) { // Assuming the "Action" column is the last column
                        columns.push($(this).text());
                    }
                });
                ...
                function filterRow(rowData) {
                    return rowData.slice(0, 8); // Exclude the last column (Action)
                }
                ...
                const autoTableData = rows.map(row => {
                    return row.map((cell, index) => {
                        if (index === 5) { // The "Booking Status" column
