...
<?php
    ...
    $role = 2; // agent role value
    $payments = $objBooking->agent_payment($role);
    $i = 0;
?>
    <div class="container-fluid pt-4 px-4">
        <div class="border-primary rounded p-4">
            <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block text-left">Payment List of Agents</strong>    
