                        ...
                        <table id="myTable" class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php
                                foreach($datas as $k => $row) { 
                                    //========================
                                           ...
                                           if(($row['credit_balance'] ===   NULL)  || ($row['credit_balance'] == "")) {
                                            ...
                                            $filteredData[] = [$i,$row['first_name']." ".$row['last_name'],$row['email'],$row['mobile'],$row['agent_status'],$row['credit_balance'],$row['id'],$row['request_amount'],$row['credit_request']];
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong class='me-2'><span>&#8377; <?php echo $row['credit_balance']; ?></span></strong><button name='addbtn' id= '<?php echo $buttonId; ?>' class='btn btn-sm btn-secondary' data-bs-toggle='modal' data-bs-target='<?php echo $modalId; ?>' data-amount="<?php echo $row['credit_balance']; ?>" data-uid="<?php echo $row['id']; ?>">Add More</button>
                                    <?php

                                    //check the agent credit requested or not . get amount and display request.
                                    if($row['credit_request'] == 1)
                                    {
                                        $amount = $row['request_amount'];
                                        echo '<button type="button" class="btn btn-warning">$'.$amount .' Request</button>';
                                    }
                                    ?>
                                    </td>
                        ...
                        <div class="modal-body">
                            <form class="row" id="<?php echo $uid; ?>"  onsubmit="myFunction(event,<?php echo strval($uid); ?>)">
                                <div class="col-12 mb-2">
                                    ...
                                    <?php if($v[8]){ ?>
                                        <input type="text" id="amount" name="amount" class="form-control"  value="<?php echo $v[7]; ?>">                                 
                                        <span class="errortext" id="amountError" style="color:red"></span>
                                    <?php }else{ ?>
                                        <input type="text" id="amount" name="amount" class="form-control" placeholder="Credit amount in dollar">                                 
                                        <span class="errortext" id="amountError" style="color:red"></span>
                                    <?php } ?>        
                                </div>
