                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $row['email'] ?></td>
                             ...
                             <td> <span class='user-active'><input id=<?php echo $checkboxId; ?> type="checkbox"<?php echo $row['agent_status']; ?> onclick='toggleStatus(this, " + row[6] + ")'><label for='" + checkboxId + "' class='btn btn-sm'></label></span></td>
                              <td><span class="badge bg-success"><?php echo $row['agent_status']; ?></span></td>  
