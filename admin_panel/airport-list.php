    ...
    <!-- Product List Start -->
            ...
            <div class="container-fluid h-100 pt-4 px-4">
                <div class="border-primary rounded p-4">
                    <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block text-left">Airport Locations</strong>
                        <a href="add-airport-loc.php" class="btn btn-primary">Add Airport Locations</a>   
                    ...
                    ?>
                        <tr>
                           ...
                           <td><a href="edit-airport.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pen">&nbsp;</i></a><a class="btn text-secondary delete"  onclick="return confirm("are you sure you want to delete?")" href="edit-airport.php?action=delete&amp;uid=<?php echo $row['id']; ?>" ><i class="fa fa-trash">&nbsp;</i></a></td> 
