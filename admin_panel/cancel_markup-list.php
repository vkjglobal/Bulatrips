...
$objBooking		= 	new Booking();
 $listmarkup	=   $objBooking->markupList_cancel();
 //print_r($listmarkup);
 $i  =   0;
                    ...
                    <div class="table-responsive">
                        ...
                        if (count($listmarkup)> 0) {
                            foreach($listmarkup as $k => $row) {
                                ...
                                $i++;
                                if($row['role_id'] == 3){
                                    $role ="Void(Same Day of Ticket Issuance Date)";
                                }
                                else if($row['role_id'] == 4){
                                    $role = "Refund(Day after Ticket Issuance Date)";
                                }
                                else if($row['role_id'] == 5){
                                    $role = "No Show Fee(at Departure Date)";
                                }
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $formattedDate ;?></td>
                             <td><a href="edit_cancel_markup-list.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pen">&nbsp;</i></a></td>
