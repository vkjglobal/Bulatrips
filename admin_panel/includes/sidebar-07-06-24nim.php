...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar navbar-dark">
                ...
                <div class="navbar-nav w-100">
                  ...
                  <!--  <div class="nav-item dropdown">
                    <a href="markup-list.php" class="nav-link <?php if($activePage == 'markup-list' || $activePage == 'edit-markup' ) { echo 'active'; } ?>"><i class="fa fa-laptop me-2"></i>Mark up</a>
                    </div>
                    -->
                     <div class="nav-item dropdown">
                   ...
                   <div class="nav-item dropdown">
                    ...
                    <!-- <div class="nav-item dropdown">
                        <a href="review-list.php" class="nav-link <?= ($activePage == 'review-list') ? 'active':''; ?>" ><i class="fa fa-laptop me-2"></i>Product Review</a>    
                    </div> -->
                    <div class="nav-item dropdown">
                        <a href="contact-list.php" class="nav-link <?= ($activePage == 'contact-list') ? 'active':''; ?>" ><i class="fa fa-laptop me-2"></i>Contact Us</a>    
                    </div>
                    <!-- <div class="nav-item dropdown">
                        <a href="terms-and-condition-list.php" class="nav-link <?= ($activePage == 'terms-and-condition-list' || $activePage == 'edit-terms') ? 'active':''; ?>" ><i class="fa fa-laptop me-2"></i>Terms&Conditions</a>    
                    </div>
                    <div class="nav-item dropdown">
                        <a href="subscribers-list.php" class="nav-link <?= ($activePage == 'subscribers-list') ? 'active':''; ?>" ><i class="fa fa-laptop me-2"></i>Subscribers</a>    
                    </div> -->
                    
                    <!-- <div class="nav-item dropdown">
                        <a href="software-dovelopment-list.php" class="nav-link " ><i class="fa fa-laptop me-2"></i>S/W Development</a>    
                    </div> -->
