...
?>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block text-left">Mark Up Fee For Booking</strong>    
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $formattedDate; ?></td>
                             <td><a href="edit-markup.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pen">&nbsp;</i></a></td>
