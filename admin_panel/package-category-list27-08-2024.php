...
function updatePagination() {
    ...
    // Previous button
    paginationHTML += "<li class='page-item" + (currentPage === 1 ? " disabled" : "") + "'><a class='page-link' href='javascript:void(0)' onclick='prevPage()'>Previous</a></li>";
    ...
    for (var i = 1; i <= totalPages; i++) {
        ...
        paginationHTML += "'><a class='page-link' href='javascript:void(0)' onclick='goToPage(" + i + ")'>" + i + "</a></li>";
    }
    
    // Next button
    paginationHTML += "<li class='page-item" + (currentPage === totalPages ? " disabled" : "") + "'><a class='page-link' href='javascript:void(0)' onclick='nextPage()'>Next</a></li>";
