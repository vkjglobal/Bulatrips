...
if (isset($_GET['id']) && ($_GET['id']) != "") {
    ...
    $listmarkup    =   $objBooking->getsettingsInfo($markupId);
}
if (isset($_POST['submit'])) {
    $markupperc    =  trim($_POST['markupname']);
    $upateArr    =   $objBooking->updateIPGSettings($markupId, $markupperc);
    if ($upateArr === true) {
        echo "<script>";
        ...
        <div class="col-12">
            <form class="" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="row" style="display: flex;">
                    <div class="col-12">
                        <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">Edit IPG percentage</strong>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="">IPG percentage</label>
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <a href="settings.php" class="btn btn-primary btn-typ3 ms-2">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
