...
<?php
    ...
    $comp = $conn->prepare("SELECT count(id) FROM temp_booking WHERE booking_status = 'Booked' AND ticket_status = 'Ticketed' AND user_id = :id");
    $comp->execute(array('id' => $id));
    $result = $comp->fetch();
    ...
    $pend2 = $conn->prepare("SELECT count(id) as count FROM temp_booking WHERE booking_status = 'Booked' AND ticket_status = 'TktInProcess' AND user_id = :id");
    $pend2->execute(array('id' => $id));
    $result2 = $pend2->fetch();
...
// echo $pending;
    ...
    $wait = $conn->prepare("SELECT count(id) as count FROM temp_booking WHERE booking_status = 'unconfirmed' AND user_id = :id");
                ...
                <div class="col-md-3 pr-md-3 mb-3">
                    <div class="top-tabs-container">
                        <div class="d-flex flex-column align-items-center mb-3">
                            <span class="usr-pic" style="width: 100px; border-radius: 50%; overflow: hidden; border: 1px solid #121e7e;">
                                <img src="uploads/profile/<?php echo $user['image']; ?>" alt="">
                            </span>
                    ...
                    <div class="blnc-amnt d-flex flex-wrap justify-content-between mb-2 p-3">
                        <?php if(isset($user['credit_balance'])){ ?>
                            <strong>Balance</strong><strong>$<?php echo $user['credit_balance']; ?></strong>
                        <?php }else{ ?>
                            <strong>Balance</strong><strong>$00.00</strong>
                        <?php } ?>
                    </div>
                    <button type="button" class="btn btn-typ4 text-uppercase fs-14 fw-600 w-100 rounded-0 py-3" data-toggle="modal" data-target="#exampleModalCenter">
                        Request
                    </button>
                </div>
                <!-- Modal -->
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Request for Balance</h5>
                            ...
                            <form method="post" id="requestForm">
                                <div class="modal-body">
                                    <input class="form-control" id="requestAmount" name="requestAmount" placeholder="Credit amount in dollar"></input>
                                </div>
                                <input type="hidden" name="uid" class="uid" class="form-control" value="<?php echo $user['id']; ?>">
                                <div class="modal-footer">
                                    <button type="submit" name="Submit" id="Submit" class="btn btn-typ4">Send</button>
                                </div>
                            </form>
                        </div>
                    </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="redirectToReviewPage()">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="redirectToReviewPage()">Close</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-content col-md-9 pl-md-0">
                                ...
                                <div class="col-xl-3 col-sm-6 mb-2">
                                    <div class="card1">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="text-uppercase">COMPLETED</strong>
                                        </div>
                                        <div class="count">
                                            <?php 
                                                if($completed){
                                ...
                                <div class="col-xl-3 col-sm-6 mb-2">
                                    <div class="card1">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="text-uppercase">WAITING</strong>
                                        </div>
                                        <div class="count">
                                            <?php 
                                                if($waiting){
                    ...
                    <div class="sub-tabs-container">
                        <div class="subtab-btn-wrp">
                            ...
                            <label class="subtab-label" id="a">UPCOMING</label>
                            <label class="subtab-label" id="b">COMPLETED</label>
                        ...
                        <div class="subtab-content">
                            ...
                            <div id="parent" class="d-flex flex-column">
                                ...
                                <table>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="title"><?php echo $bookingDatas['dep_location'] . " -> " . $bookingDatas['arrival_location'] . " " . $formattedDate ?> </td>
                                                ...
                                                <td class="action">
                                                    ...
                                                    <a href="cancel.php?booking_id=<?php echo $bookingDatas['id']; ?>" class="btn btn-typ3 w-100 mb-2">
                                                    ...
                                                    <a href="flight-booking-details.php?booking_id=<?php echo $bookingDatas['id']; ?>" class="btn btn-typ4 w-100">
                                                        <path d="M6 0C4.81331 0 3.65328 0.351894 2.66658 1.01118C1.67989 1.67047 0.910851 2.60754 0.456725 3.7039C0.0025997 4.80025 -0.11622 6.00665 0.115291 7.17054C0.346802 8.33443 0.918247 9.40352 1.75736 10.2426C2.59648 11.0818 3.66557 11.6532 4.82946 11.8847C5.99335 12.1162 7.19975 11.9974 8.2961 11.5433C9.39246 11.0891 10.3295 10.3201 10.9888 9.33342C11.6481 8.34672 12 7.18669 12 6C12 4.4087 11.3679 2.88258 10.2426 1.75736C9.11742 0.632141 7.5913 0 6 0V0ZM1.2 6C1.20236 4.93462 1.5591 3.90031 2.214 3.06L8.94 9.786C8.23085 10.3355 7.3819 10.6752 6.48945 10.7667C5.597 10.8582 4.69677 10.6977 3.89089 10.3035C3.085 9.90935 2.40572 9.2972 1.9301 8.53653C1.45447 7.77586 1.20155 6.89712 1.2 6ZM9.786 8.94L3.06 2.214C3.9841 1.51165 5.1314 1.16794 6.28945 1.24652C7.4475 1.3251 8.53785 1.82065 9.3586 2.6414C10.1794 3.46215 10.6749 4.5525 10.7535 5.71055C10.8321 6.8686 10.4883 8.0159 9.786 8.94Z" fill="white" />
                                                        </svg> Details
                                                        <!-- </button> -->
                                                    </a>
                                ...
                                <div class="b box booking-completed">
                                <table>
                                        <?php
                                        $today = date('Y-m-d');

                                        $stmtbookingid = $conn->prepare('SELECT * FROM temp_booking WHERE user_id = :userid and booking_status = :bookingStatus and  DATE(dep_date) >= :today and ticket_status = :ticketStatus');

                                        $stmtbookingid->execute(array('userid' => $id, 'bookingStatus' => "Booked", 'today' => $today, 'ticketStatus' => "Ticketed"));
                                        $bookingData = $stmtbookingid->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($bookingData as $bookingDatas) {
                                            $dateTime = new DateTime($bookingDatas['dep_date']);
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="status"><?php echo $bookingDatas['booking_status']; ?></td>
                                                <td class="action">
                                                    <button type="button" class="btn btn-typ3 w-100 mb-2"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M6 0C4.81331 0 3.65328 0.351894 2.66658 1.01118C1.67989 1.67047 0.910851 2.60754 0.456725 3.7039C0.0025997 4.80025 -0.11622 6.00665 0.115291 7.17054C0.346802 8.33443 0.918247 9.40352 1.75736 10.2426C2.59648 11.0818 3.66557 11.6532 4.82946 11.8847C5.99335 12.1162 7.19975 11.9974 8.2961 11.5433C9.39246 11.0891 10.3295 10.3201 10.9888 9.33342C11.6481 8.34672 12 7.18669 12 6C12 4.4087 11.3679 2.88258 10.2426 1.75736C9.11742 0.632141 7.5913 0 6 0V0ZM1.2 6C1.20236 4.93462 1.5591 3.90031 2.214 3.06L8.94 9.786C8.23085 10.3355 7.3819 10.6752 6.48945 10.7667C5.597 10.8582 4.69677 10.6977 3.89089 10.3035C3.085 9.90935 2.40572 9.2972 1.9301 8.53653C1.45447 7.77586 1.20155 6.89712 1.2 6ZM9.786 8.94L3.06 2.214C3.9841 1.51165 5.1314 1.16794 6.28945 1.24652C7.4475 1.3251 8.53785 1.82065 9.3586 2.6414C10.1794 3.46215 10.6749 4.5525 10.7535 5.71055C10.8321 6.8686 10.4883 8.0159 9.786 8.94Z" fill="white" />
                                ...
                                <div class="c box booking-incompleted">
                                    <table>
                                    <?php
                                        $today = date('Y-m-d');

                                        // Prepare and execute the first query
                                        $stmtbookingid = $conn->prepare("SELECT * FROM temp_booking WHERE booking_status = 'Booked' AND ticket_status = 'TktInProcess' AND user_id = :id");
                                        $stmtbookingid->execute(array('id' => $id));
                                        $bookingData = $stmtbookingid->fetchAll(PDO::FETCH_ASSOC);

                                        // Prepare and execute the second query
                                        $stmtbookingid1 = $conn->prepare("SELECT * FROM temp_booking WHERE booking_status = 'Booked' AND mf_reference IS NOT NULL AND ticket_status IS NOT NULL AND user_id = :id");
                                        $stmtbookingid1->execute(array('id' => $id));
                                        $bookingData1 = $stmtbookingid1->fetchAll(PDO::FETCH_ASSOC);

                                        // Merge the results from both queries
                                        $allBookingData = array_merge($bookingData, $bookingData1);
                                ...
                                <div class="d box booking-cancelled">
                                    <table>
                                        <?php
                                        $today = date('Y-m-d');
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="status"><?php echo $bookingDatas['booking_status']; ?></td>
                                                <td class="action">
                                                    <button type="button" class="btn btn-typ3 w-100 mb-2" disabled><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M6 0C4.81331 0 3.65328 0.351894 2.66658 1.01118C1.67989 1.67047 0.910851 2.60754 0.456725 3.7039C0.0025997 4.80025 -0.11622 6.00665 0.115291 7.17054C0.346802 8.33443 0.918247 9.40352 1.75736 10.2426C2.59648 11.0818 3.66557 11.6532 4.82946 11.8847C5.99335 12.1162 7.19975 11.9974 8.2961 11.5433C9.39246 11.0891 10.3295 10.3201 10.9888 9.33342C11.6481 8.34672 12 7.18669 12 6C12 4.4087 11.3679 2.88258 10.2426 1.75736C9.11742 0.632141 7.5913 0 6 0V0ZM1.2 6C1.20236 4.93462 1.5591 3.90031 2.214 3.06L8.94 9.786C8.23085 10.3355 7.3819 10.6752 6.48945 10.7667C5.597 10.8582 4.69677 10.6977 3.89089 10.3035C3.085 9.90935 2.40572 9.2972 1.9301 8.53653C1.45447 7.77586 1.20155 6.89712 1.2 6ZM9.786 8.94L3.06 2.214C3.9841 1.51165 5.1314 1.16794 6.28945 1.24652C7.4475 1.3251 8.53785 1.82065 9.3586 2.6414C10.1794 3.46215 10.6749 4.5525 10.7535 5.71055C10.8321 6.8686 10.4883 8.0159 9.786 8.94Z" fill="white" />
                                                        </svg> Cancel Booking</button>
                                                    <button type="button" class="btn btn-typ4 w-100" disabled><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M6 0C4.81331 0 3.65328 0.351894 2.66658 1.01118C1.67989 1.67047 0.910851 2.60754 0.456725 3.7039C0.0025997 4.80025 -0.11622 6.00665 0.115291 7.17054C0.346802 8.33443 0.918247 9.40352 1.75736 10.2426C2.59648 11.0818 3.66557 11.6532 4.82946 11.8847C5.99335 12.1162 7.19975 11.9974 8.2961 11.5433C9.39246 11.0891 10.3295 10.3201 10.9888 9.33342C11.6481 8.34672 12 7.18669 12 6C12 4.4087 11.3679 2.88258 10.2426 1.75736C9.11742 0.632141 7.5913 0 6 0V0ZM1.2 6C1.20236 4.93462 1.5591 3.90031 2.214 3.06L8.94 9.786C8.23085 10.3355 7.3819 10.6752 6.48945 10.7667C5.597 10.8582 4.69677 10.6977 3.89089 10.3035C3.085 9.90935 2.40572 9.2972 1.9301 8.53653C1.45447 7.77586 1.20155 6.89712 1.2 6ZM9.786 8.94L3.06 2.214C3.9841 1.51165 5.1314 1.16794 6.28945 1.24652C7.4475 1.3251 8.53785 1.82065 9.3586 2.6414C10.1794 3.46215 10.6749 4.5525 10.7535 5.71055C10.8321 6.8686 10.4883 8.0159 9.786 8.94Z" fill="white" />
                                                        </svg> Details</button>
                                                </td>
                                            </tr>
                ...
                <div class="tab-content col-md-9 pl-md-0">
                    ...
                    <div class="cancellation-container box-border p-4">
                        ...
                        <div class="d-flex flex-md-row flex-column-reverse justify-content-between">
                            ...
                            <ul id="filterOptionsPackage" class="cancellation-tab-filter flex-md-row flex-column-reverse d-none">
                                <li><a href="#" class="upcoming">Upcoming</a>
                                </li>
                                <li><a href="#" class="cancelled">Cancelled</a>
                                </li>
                            ...
                            <div class="position-relative slct-btn-wrp">
                                <ul class="select-tab-item">
                                    <li class="active-btn">
                                        <button type="button" data-target="#filterOptionsFlight" class="btn filterOptionsFlight">Flight</button>
                                        <button type="button" class="btn downbtn">Down</button>
                                    </li>
                                    <li>
                                        <button type="button" data-target="#filterOptionsPackage" class="btn filterOptionsPackage">Package</button>
                                        <button type="button" class="btn downbtn">Down</button>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div id="FlightCancellationList" class="cancellation-tab-filter-content">
                            <div class="item upcoming">
                                <ul class="row align-items-center ml-0 mr-0">
                                    <li class="col-md-1 text-md-center mb-md-0 mb-2"><svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.012 7.59L4.502 0.518L6.433 0L13.384 6.42L18.646 5.01C19.0303 4.9071 19.4397 4.96107 19.7842 5.16004C20.1287 5.35902 20.3801 5.6867 20.483 6.071C20.5859 6.4553 20.5319 6.86474 20.333 7.20924C20.134 7.55375 19.8063 7.8051 19.422 7.908L4.45 11.918L3.674 9.02L3.915 8.955L6.382 11.4L3.756 12.104C3.54067 12.1617 3.31221 12.1459 3.10693 12.0589C2.90165 11.9719 2.73132 11.8189 2.623 11.624L0 6.898L1.449 6.51L3.915 8.955L9.012 7.589V7.59ZM2.534 14.958H18.534V16.958H2.534V14.958Z" fill="#2391D1"></path>
                                        </svg></li>
                                            ...
                                            <div class="d-flex flex-column align-items-center direction-icon ml-2 mr-2">
                                                <span class="oneway d-flex">
                                                    <svg width="29" height="12" viewBox="0 0 29 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M29 6L19 0.226497V11.7735L29 6ZM0 7L20 7V5L0 5L0 7Z" fill="#A19595"></path>
                                                    </svg>
                                                </span>
                                                <span class="return d-flex">
                                                    <svg width="29" height="12" viewBox="0 0 29 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M0 6L10 11.7735L10 0.226497L0 6ZM9 7L29 7V5L9 5V7Z" fill="#A19595"></path>
                                                    </svg>
                                                </span>
                                            </div>
                                            <span class="">DXB</span>
                ...
                <div class="tab-content col-md-9 pl-md-0">
                    ...
                    <div class="box-border p-4">
                        <div class="row profileinfo">
                            ...
                            <div class="col-12">
                                <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">Agency Information</strong>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4 col-5">Agency Name</div>
                                    <div class="col-1">:</div>
                                    <div class="col"><?php echo $user['agency_name'] ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-4 col-5">Address</div>
                                    <div class="col-1">:</div>
                                    <div class="col"><?php echo $user['agency_address'] ?></div>
                                </div>

                                <div class="row mb-2">
                                    <div class="col-md-4 col-5">Country</div>
                                    <div class="col-1">:</div>
                                    <div class="col"><?php echo $user['agency_country'] ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-4 col-5">state</div>
                                    <div class="col-1">:</div>
                                    <div class="col"><?php echo $user['agency_state'] ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-4 col-5">Town / City</div>
                                    <div class="col-1">:</div>
                                    <div class="col"><?php echo $user['agency_city'] ?></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-4 col-5">ZIP Code</div>
                                    <div class="col-1">:</div>
                                    <div class="col"><?php echo $user['agency_zip_code'] ?></div>
                                </div>
                            </div>
                        </div>
...
<!-- edit form code -->
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="fname" id="fname" value="<?php echo $user['first_name']; ?>" class="form-control">

                                        </div>
                                        <div class="col-6 mb-3">
                                            <label for="">Last Name</label>
                                            <input type="text" name="lname" id="lname" value="<?php echo $user['last_name']; ?>" class="form-control">
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="Address" id="address" value="<?php echo $user['contact_address']; ?>" class="form-control">
                                        </div>
                                        <div class="col-6 mb-3">
                                            <label for="">Country</label>
                                            <select id="agentusercountry" name="agentusercountry" class="form-control">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <select id="agentuserstate" name="agentuserstate" class="form-control">
                                                <option value="">Select State</option>
                                            </select>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <label for="">City</label>
                                            <input type="text" name="agentusercity" id="agentusercity" class="form-control" value="<?php echo $user['city']; ?>">
                                        </div>
                                        <div class="col-6 mb-3">
                                            <label for="">Zip Code / Postel Code</label>
                                            <input type="text" name="zipcode" id="zipcode" class="form-control" value="<?php echo $user['zip_code']; ?>">
                                        </div>
                                        <input type="hidden" name="uid" id="uid" class="form-control" value="<?php echo $user['id']; ?>">
                                        <input type="hidden" name="uid" id="hagentcountry" class="form-control" value="<?php echo $user['country']; ?>">
                                        <input type="hidden" name="uid" id="hagentstate" class="form-control" value="<?php echo $user['state']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">Agency Informations</strong>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="">Agency Name</label>
                                            <input type="text" name="agencyname" id="agencyname" value="<?php echo $user['agency_name']; ?>" class="form-control">

                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Address</label>
                                            <input type="text" name="agencyaddress" id="agencyaddress" value="<?php echo $user['agency_address']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Country</label>
                                            <select id="agencyupdatecountry" name="agencyupdatecountry" class="form-control">
                                                <option value="">Loading countries...</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">State</label>
                                            <select id="agencyupdatstate" name="agencyupdatstate" class="form-control">
                                                <option value="">Select State</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">City</label>
                                            <input type="text" name="agencycity" id="agencycity" value="<?php echo $user['agency_city']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Zip Code / Postel Code</label>
                                            <input type="text" name="agencyzip" id="agencyzip" value="<?php echo $user['agency_zip_code']; ?>" class="form-control">
                                        </div>
                                        <input type="hidden" name="hagencycountry" id="hagencycountry" class="form-control" value="<?php echo $user['agency_country']; ?>">
                                        <input type="hidden" name="hagencystate" id="hagencystate" class="form-control" value="<?php echo $user['agency_state']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">KYC</strong>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="">Owner Name</label>
                                            <input type="text" name="ownername" id="ownername" value="<?php echo $user['owner_name']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Date of Birth</label>
                                            <input type="date" name="dob" id="dob" value="<?php echo $user['dob']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            ?>
                                            <select name="kycid" id="kycid" class="form-control">
                                                <?php
                                                foreach ($options as $option) : ?>
                                                    <!-- <option value="<?= $option['id'] ?>"><?= $option['title'] ?></option> -->
                                                    <option value="<?= $option['id'] ?>" <?= ($option['id'] == $user['kyc_id']) ? ' selected' : '' ?>><?= $option['title'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Proof Number</label>
                                            <input type="text" name="kycnumber" id="kycnumber" value="<?php echo $user['kyc_number']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">TAN</label>
                                            <input type="email" name="tan" id="tan" value="<?php echo $user['tan']; ?>" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <label class="uploadFile form-control">
                                                <span class="filename"></span>
                                                <input type="file" class="inputfile form-control" name="ky-image" id="ky-image">
                                ...
                                <div class="col-12 d-flex">
                                    <button type="submit" id="agentupdate" class="btn btn-typ4">UPDATE PROFILE</button>
                                    <button type="button" VALUE="Back" onClick="history.go();" class="btn btn-typ3 ml-2">CANCEL</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-5 mb-3">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <input type="password" name="current-password" id="current-password" class="form-control" placeholder="Enter Current Password" >
                                            ...
                                            <div class="col-12 mb-3">
                                                <input type="password" name="new-varify-password" id="new-varify-password" class="form-control" placeholder="Confirm New Password" >
                                                <span id="verify-password-error" style="color:red;"></span>
                                            </div>
                                            <div class="col-12">
                                            <button type="submit" id="change-password" class="btn btn-typ3 pl-5 pr-5">SAVE</button>
                ...
                <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Your password has been changed successfully. Please relogin with your new password.
                            </div>
                            <div class="modal-footer">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="star-rating">
                                        <input type="radio" id="5-stars" name="rating" value="5" <?php if($star == 5) echo 'checked'; ?> />
                                        <label for="5-stars" class="star">&#9733;</label>
                                        <input type="radio" id="4-stars" name="rating" value="4" <?php if($star == 4) echo 'checked'; ?>/>
                                        <label for="4-stars" class="star">&#9733;</label>
                                        <input type="radio" id="3-stars" name="rating" value="3" <?php if($star == 3) echo 'checked'; ?>/>
                                        <label for="3-stars" class="star">&#9733;</label>
                                        <input type="radio" id="2-stars" name="rating" value="2" <?php if($star == 2) echo 'checked'; ?> />
                                        <label for="2-stars" class="star">&#9733;</label>
                                        <input type="radio" id="1-star" name="rating" value="1" <?php if($star == 1) echo 'checked'; ?>/>
                                ...
                                <div class="desc col-6 d-flex flex-column mb-3">
                                    ...
                                    <input class="form-control h-auto" name="title" id="title" value="<?php echo $review[0]['title']; ?>" placeholder="Enter title">
                                </div>
                                <div class="desc col-6 d-flex flex-column mb-3">
                                    <label for="description" class="fs-16 fw-500 light-blue-txt mb-3 d-block">Description</label>
                                    <textarea class="form-control h-auto" name="description" id="description" cols="30" rows="6" placeholder="write your review here.."><?php echo $review[0]['description']; ?></textarea>
                                </div>
                                <div class="desc col-6 d-flex flex-column mb-3">
                                    <label for="p-image" class="fs-16 fw-500 light-blue-txt mb-3 d-block">Upload Image</label>
                                        <label class="uploadFile form-control">
                                        <span class="filename"></span>
                                        <input type="file" class="form-control" name="review_pic" id="review_pic" placeholder="upload profile image"> 
                                    </label>
                                    <?php if($review){?>
                            ...
                            <div class="error-container"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" id="review_delete" class="btn btn-typ4" data-userid="<?php echo $id; ?>">Clear</button>
                                    </div>
                                </div>
                            </div>
                        </form>
