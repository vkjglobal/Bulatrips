            ...
            <div class="row user-dash-main-tab">
                <div class="col-md-3 pr-md-3 mb-3">
                    ...
                    <div class="blnc-amnt d-flex flex-wrap justify-content-between mb-2 p-3">
                        <strong>Balance</strong><strong>$20,000.00</strong>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <textarea name="" class="form-control" id="" cols="30" style="height: 150px;" rows="10"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-typ4">Send</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-xl-3 col-sm-6 mb-2">
                                    <div class="card1">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong class="text-uppercase">IN COMPLETED</strong>
                                        </div>
                        ...
                        <div class="subtab-content">
                            ...
                            <div id="parent" class="d-flex flex-column">
                                ...
                                <table>
                                        ...
                                        $stmtbookingid = $conn->prepare('SELECT * FROM temp_booking WHERE user_id = :userid and booking_status = :bookingStatus and  dep_date >= :today');
