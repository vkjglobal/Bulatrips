...
if (!isset($_SESSION['user_id'])) {
    ...
    $cDate = date('Y-m-d');
    // print_r($cDate);
    //nimmi - 10-09-2024 - upcoming
    //fetch all upcoming flight count
    ...
    $comp->execute(array('cDate' => $cDate, 'id' => $id));
    $result = $comp->fetch();
    // print_r($result);
    $completed = $result['count(id)'];

    // fetch confirmed flight count
    $comp = $conn->prepare("SELECT count(id) FROM temp_booking WHERE dep_date >= :cDate AND user_id = :id AND booking_status = :booked AND ticket_status = :ticket AND mf_reference != ''");
    $comp->execute(array('cDate' => $cDate, 'booked' => 'Booked', 'ticket' => 'Ticketed', 'id' => $id));
    $result = $comp->fetch();
    // print_r($result);
    $confirmed = $result['count(id)'];

    // fetch pending flight count
    $comp = $conn->prepare("SELECT count(id) FROM temp_booking WHERE dep_date >= :cDate AND user_id = :id AND booking_status = :booked AND ticket_status = :ticket AND mf_reference != ''");
    $comp->execute(array('cDate' => $cDate, 'booked' => 'Booked', 'ticket' => 'TktInProcess', 'id' => $id));
    $result = $comp->fetch();
    // print_r($result);
    $pending1 = $result['count(id)'];

    // echo $cDate;
    // print_r($pending1);
    $notbook = $conn->prepare("SELECT count(id) FROM temp_booking WHERE dep_date >= :cDate AND user_id = :id AND booking_status = 'NotBooked' AND mf_reference != ''");
    $notbook->execute(array('cDate' => $cDate, 'id' => $id));
    $result = $notbook->fetch();
    // print_r($result);
    $notbook = $result['count(id)'];

    $comp = $conn->prepare("SELECT count(id) as count FROM temp_booking WHERE booking_status = :booked AND dep_date >= :cDate AND user_id = :id");
    $comp->execute(array('cDate' => $cDate, 'booked' => 'BookingInProcess', 'id' => $id));
    $result = $comp->fetch();
    // print_r($result);
    $pending2 = $result['count'];
    // echo $pending3;
                ...
                <div class="col-md-3 pr-md-3 mb-3">
                    <div class="top-tabs-container">
                        <div class="d-flex flex-column align-items-center mb-3">
                            <span class="usr-pic"
                                style="width: 100px; border-radius: 50%; overflow: hidden; border: 1px solid #121e7e;">
                                <img src="uploads/profile/<?php echo $user['image']; ?>" alt="">
                            </span>
                            <span class="usr-nm fw-500 light-blue-txt"><?php echo $user['first_name'] ?></span>
                            <button type="button" class="btn btn-typ4 fs-14 fw-500 pl-lg-4 pr-lg-4 pl-3 pr-3">My
                                Account</button>
                        </div>
                    ...
                    <button type="button" class="btn btn-typ4 text-uppercase fs-14 fw-600 w-100 rounded-0 py-3"
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" id="requestForm">
                                <div class="modal-body">
                                    <input class="form-control" id="requestAmount" name="requestAmount"
                                        placeholder="Credit amount in dollar"></input>
                                </div>
                                <input type="hidden" name="uid" class="uid" class="form-control"
                ...
                <div class="tab-content col-md-9 pl-md-0">
                    ...
                    <div class="sub-tabs-container">
                        <div class="subtab-btn-wrp">
                            ...
                            <label class="subtab-label" id="a">ALL UPCOMING</label>
                            ...
                            <div id="parent" class="d-flex flex-column">
                                ...
                                <div class="a box booking-pending">
                                    <table>
                                        ...
                                        $stmtbookingid = $conn->prepare("SELECT * FROM temp_booking WHERE dep_date >= :today AND user_id = :userid AND mf_reference != ''");
                                        // print_r($stmtbookingid);exit;
                                        $stmtbookingid->execute(array('userid' => $id, 'today' => $today));
                                ...
                                <div class="c box booking-incompleted" style="display:none;">
                                    <table>
                                        ...
                                        $stmtbookingid = $conn->prepare("SELECT * FROM temp_booking WHERE dep_date >= :cDate AND user_id = :id AND booking_status = :booked AND ticket_status = :ticket AND mf_reference != ''");
                                        $stmtbookingid->execute(array('cDate' => $cDate, 'booked' => 'Booked', 'ticket' => 'TktInProcess', 'id' => $id));
                                        $bookingData = $stmtbookingid->fetchAll(PDO::FETCH_ASSOC);

                                        // Prepare and execute the second query
                                        $stmtbookingid1 = $conn->prepare("SELECT * FROM temp_booking WHERE dep_date >= :cDate AND user_id = :id AND booking_status = :booked AND ticket_status = :ticket AND mf_reference != ''");
                                        $stmtbookingid1->execute(array('cDate' => $cDate, 'booked' => 'Booked', 'ticket' => 'NULL', 'id' => $id));
                                        $bookingData1 = $stmtbookingid1->fetchAll(PDO::FETCH_ASSOC);

                                        // Prepare and execute the 3 query
                                        $stmtbookingid3 = $conn->prepare("SELECT * FROM temp_booking WHERE booking_status = :booked AND dep_date >= :cDate AND user_id = :id");
                                        $stmtbookingid3->execute(array('booked' => 'BookingInProcess', 'cDate' => $cDate, 'id' => $id));
                                        $bookingData3 = $stmtbookingid3->fetchAll(PDO::FETCH_ASSOC);
                                        // print_r($bookingData3);
                                        // Merge the results from both queries
                                        $allBookingData = array_merge($bookingData, $bookingData1, $bookingData3);
                                    ...
                                    <table>
                                        ...
                                        foreach ($allCancelData as $bookingDatas) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="status"><?php echo $bookingDatas['booking_status']; ?></td>
                                                <td class="action">
                                                    <button type="button" class="btn btn-typ3 w-100 mb-2" disabled><svg
                ...
                <!-- <div class="tab-content col-md-9 pl-md-0">
                    ...
                    <div class="cancellation-container box-border p-4">
                        ...
                        <div class="d-flex flex-md-row flex-column-reverse justify-content-between">
                            <ul id="filterOptionsFlight"
                                class="cancellation-tab-filter d-flex flex-md-row flex-column-reverse">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="lname" id="lname"
                                                value="<?php echo $user['last_name']; ?>" class="form-control">
                                        </div>

                                        <div class="col-6 mb-3">
                                            <label for="">Phone Number</label>
                                            <input type="text" name="mobile" id="mobile"
                                                value="<?php echo $user['mobile']; ?>" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <label class="uploadFile form-control">
                                                ...
                                                <input type="file" class="inputfile form-control" name="p-image"
                                                    id="p-image">
                                            </label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="agentusercity" id="agentusercity" class="form-control"
                                        ...
                                        <input type="hidden" name="uid" id="uid" class="form-control"
                                            value="<?php echo $user['id']; ?>">
                                        <input type="hidden" name="uid" id="hagentcountry" class="form-control"
                                            value="<?php echo $user['country']; ?>">
                                        <input type="hidden" name="uid" id="hagentstate" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="agencyname" id="agencyname"
                                                value="<?php echo $user['agency_name']; ?>" class="form-control">

                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Address</label>
                                            <input type="text" name="agencyaddress" id="agencyaddress"
                                                value="<?php echo $user['agency_address']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Country</label>
                                            <select id="agencyupdatecountry" name="agencyupdatecountry"
                                                class="form-control">
                                                <option value="">Loading countries...</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="">City</label>
                                            <input type="text" name="agencycity" id="agencycity"
                                                value="<?php echo $user['agency_city']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">Zip Code / Postel Code</label>
                                            <input type="text" name="agencyzip" id="agencyzip"
                                                value="<?php echo $user['agency_zip_code']; ?>" class="form-control">
                                        </div>
                                        <input type="hidden" name="hagencycountry" id="hagencycountry" class="form-control"
                                            value="<?php echo $user['agency_country']; ?>">
                                        <input type="hidden" name="hagencystate" id="hagencystate" class="form-control"
                                            value="<?php echo $user['agency_state']; ?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="ownername" id="ownername"
                                                value="<?php echo $user['owner_name']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="kycnumber" id="kycnumber"
                                                value="<?php echo $user['kyc_number']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="">TAN</label>
                                            <input type="email" name="tan" id="tan" value="<?php echo $user['tan']; ?>"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <label class="uploadFile form-control">
                                                <span class="filename"></span>
                                                <input type="file" class="inputfile form-control" name="ky-image"
                                                    id="ky-image">
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-md-5 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                <input type="password" name="new-varify-password" id="new-varify-password"
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="desc col-6 d-flex flex-column mb-3">
                                    ...
                                    <textarea class="form-control h-auto" name="description" id="description" cols="30"
                                        rows="6"
                                        placeholder="write your review here.."><?php echo $review[0]['description']; ?></textarea>
                                </div>
                                <div class="desc col-6 d-flex flex-column mb-3">
                                    <label for="p-image" class="fs-16 fw-500 light-blue-txt mb-3 d-block">Upload
                                        Image</label>
                                    <label class="uploadFile form-control">
                                        <span class="filename"></span>
