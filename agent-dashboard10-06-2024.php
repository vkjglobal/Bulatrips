                ...
                <div class="tab-content col-md-9 pl-md-0">
                    ...
                    <div class="sub-tabs-container">
                        <div class="subtab-btn-wrp">
                            ...
                            <!-- <label class="subtab-label" id="c">INCOMPLETE</label> -->
                        ...
                        <div class="subtab-content">
                            ...
                            <div id="parent" class="d-flex flex-column">
                                ...
                                <table>
                                        ...
                                        $stmtbookingid = $conn->prepare('SELECT * FROM temp_booking WHERE user_id = :userid and booking_status = :bookingStatus and  dep_date <= :today and ticket_status = :ticketStatus');
                                ...
                                <!-- <div class="c box booking-incompleted">
                                    <table>
                                        <tr>
                                            <td class="id">15650</td>
                                            <td class="title">Dubai Fully Loaded - Buy 1 Get 1 Free (Al Seef Area) Including Dubai Shopping Festival</td>
                                            <td class="type">Stanard</td>
                                            <td class="coat">Rs. 35 213</td>
