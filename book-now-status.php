        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 col-lg-8 mb-4">
                    <div class="booking-success-msg mb-5">
                        <span class="greenTick"></span>
                        <div class="success-txt">
                            <div class="dark-blue-txt"><strong class="fw-600">sree,</strong> your order was submitted successfully!</div>
                            <p class="">Booking details has been sent to: sree@gmail.com</p>
                        </div>
                    </div>
                    <div class="book-now-form">
                        <div class="form-row border-radius-25 mb-xl-5 mb-4">
                            <strong>Your Information</strong>
                            <ul class="form-group booking-status col-12">
                                <li class="row">
                                    <label for="" class="col-md-6">First Name</label>
                                    <span class="col-md-6">Sree</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">Last name</label>
                                    <span class="col-md-6">Hari</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">Email</label>
                                    <span class="col-md-6">sree2022@gmail.com</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">Address Line 1</label>
                                    <span class="col-md-6">M.G.Road</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">Address Line 2</label>
                                    <span class="col-md-6">South Ernaulam</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">City</label>
                                    <span class="col-md-6">Kochi</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">State/Province/Region</label>
                                    <span class="col-md-6">Kerala</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">ZIP code/Postal code</label>
                                    <span class="col-md-6">682014</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">Country</label>
                                    <span class="col-md-6">India</span>
                                    <span class="col-12"><hr></span>
                                </li>
                                <li class="row">
                                    <label for="" class="col-md-6">Special Requirements</label>
                                    <span class="col-md-6">Nil</span>
                                    <span class="col-12"><hr></span>
                                </li>
                            </ul>
                ...
                <div class="col-xl-3 col-lg-4">
                    <form action="">
                        <ul class="booking-tocken-info">
                            <li>
                                <strong class="fw-600">Booking Number:</strong>
                                <span>17431</span>
                            </li>
                            <li>
                                <strong class="fw-600">Booking Date:</strong>
                                <span>10/11/2022</span>
                            </li>
                            <li>
                                <strong class="fw-600">Payment Method:</strong>
                                <span>Bank Transfer</span>
                            </li>
                            <li>
                                <strong class="fw-600">Status:</strong>
                                <span>Pending</span>
                            </li>
                        </ul>
                        <div class="right-blue-box light-blue-bg border-radius-25">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-row booking-summery white-txt">
                                        <div class="col-5 fw-500 mb-2">Email</div>
                                        <div class="col-7 fw-500 mb-2">abc@domain.com</div>
                                        <div class="col-5 fw-500 mb-2">Max people</div>
                                        <div class="col-7 fw-500 mb-2">8</div>
                                        <div class="col-5 fw-500 mb-2">No. Adult</div>
                                        <div class="col-7 fw-500 mb-2">1</div>
                                        <div class="col-5 fw-500 mb-2">Date</div>
                                        <div class="col-7 fw-500 mb-2">18/11/2022</div>
                                        <div class="col-5 fw-500">Duration</div>
                                        <div class="col-7 fw-500">2-3 hours</div>
                                        <div class="col-12 mt-4 fs-17">
