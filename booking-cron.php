                 ...
                 // $logReQ =   print_r($requestData, true);
                    ...
                    $objBookCron->_writeLog('Request Received\n'.$logReQ,'booking.txt');
                            $objBookCron->_writeLog('REsponse Received for MF:\n'.$responseData['Data']['UniqueID']. 'OR USERID='.$userId,'booking.txt');
                              $objBookCron->_writeLog('userId is '.$userId. 'BOOKING STATUS IS '.$responseData['Data']['Status'],'booking.txt');
                              $objBookCron->_writeLog('Booking ID is '.$bookingID,'booking.txt');
