...
?>
   ...
   <?php
    ...
    //     print_r($bookCanusers);exit;
     ...
     $pre_booking_status        =   $bookCanusers[0]['booking_status'];
     $pre_ticket_time_limit     =   $bookCanusers[0]['ticket_time_limit'];
     $pre_mf_reference          =   $bookCanusers[0]['mf_reference'];
     $pre_ticket_status         =   $bookCanusers[0]['ticket_status'];
     $fare_type                  =   $bookCanusers[0]['fare_type'];

     $precancelsts  =   0;
     //***************************
   // $pre_mf_reference  =   "MF23675423";
   $VoidingWindow	    =  "2023-07-31T16:29:59.997";	
  $VoidingWindow_limit =   strtotime($VoidingWindow);
   ...
   if(($fare_type == "Public") || ($fare_type == "Private")){
    ...
    echo '</script>';
      ...
      else if(($pre_ticket_status  !=  trim("Ticketed"))  &&  ($pre_ticket_status  !=  trim("TktInProcess"))) {
       ...
       echo "not eligible for cancel";
       //webfare type not eligble for cancellation 
   }
//   var_dump($void_eligible);
            ...
            <div class="row my-4">
                <div class="col-12 text-center">
                   ...
                   ?>                       
                                          ...
                                          <button type="button" class="btn btn-typ3 mb-3" id="postcancel"  onclick="postCancelApi()">Cancel Your Flight</button>
                                         <?php } 
                                          else { ?>
                                          <button type="button" class="btn btn-typ3 mb-3">Cancel Your Flight</button>
                                         <?php } ?>
                    ...
                    <!--   For post ticket cancel 
                                ...
                                <div class="col-lg-9 col-12">
                                    <ul class="form-row">
                                        <li class="col-lg-3 col-md-4 col-6 form-group chkbx mb-2">
                                            <input type="checkbox" id="traveller1">
                                            <label for="traveller1" class="fz-13 fw-400">
                                                <span class="chk-txt fs-13 fw-400">Sreejith</span>
                                            </label>
                                        </li>
                                        <li class="col-lg-3 col-md-4 col-6 form-group chkbx mb-2">
                                            <input type="checkbox" id="traveller2">
                                            <label for="traveller2" class="fz-13 fw-400">
                                                <span class="chk-txt fs-13 fw-400">Sooraj</span>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <button type="button" class="btn btn-typ3 mb-3">Search alternate flight</button>
...
// alert(mfreNum);
    $.ajax({
                ...
                type: 'POST',
                 data: { mfreNum: mfreNum,bookingId: bookingId,userId: userId,void_eligible: void_eligible },
                //data: $(this).serialize()+ '&amount=' +amountprev,
                success: function(response) {
                   //onsole.log(response);                   
               //    alert(response);
...
function postCancelVoidAPiCall(){ 
