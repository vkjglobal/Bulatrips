...
?>
    ...
    <div class=" container">
        ...
        ?>
            ...
            $subject = "Latest Update on Your Booking Status";
            $messageData = '
        <html>
        <body>
                                    ...
                                    <tr>
                                        <td bgcolor="#ffffff" style="padding-top:20px;text-align:center">
                                            ...
                                            <div align="center" style="padding:0 10px;padding-bottom:5px">
                                                <h6
                                                    style="font-family:Arial,sans-serif;color:#000000;font-size:20px;letter-spacing:-0.5px;text-align:center;margin-top:0;margin-bottom:0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="20%" style="text-align:center">
                                                                                <img align="center" width="20"
                                                                                    src="' . $_SERVER['HTTP_HOST'] . '/images/confirm-dur.png"
                                                                                    title="Time" alt="Time"
...
<?php
        ...
        if ($errStatus  ==   1) {
            ...
            $subject = "Bulatrips Booking Failed Following Airline Confirmation";

            $email =   $user['email'];
            $role =   $user['role'];
            $name   =   $user['first_name'] . " " . $user['last_name'];
            $content    =   '<p>Hello ' . $name . ',</p>
                                                <p>Your  Bulatrips Account had  a booking attempt from :' . $fromLoc . 'To ' . $ToLoc . '.Unfortunately, the booking has failed. Your payment will be refunded within 7 business days. We apologize for the inconvenience.</p>';
            ...
            $subject_Admin = "Bulatrips Agent/User Booking Failure: Balance Credit Required";


            $content_admin    =   '<p>Hello,</p>
                                                <p>This account for , ' . $role . ":" . $name . ', with email ' . $user['email'] . ' had a  transaction for booking id:' . $bookingID . '.The amount used is :$' . $totalPaid . '</p>
                                                <p>Since this booking attempt failed as per Airline status,Please credit back the same amount </p>';
            $messageData =   $objBook->getEmailContent($content_admin);
            // print_r($messageData);exit;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="closeButton1" class="btn btn-secondary close" onclick="backhomepage(<?php echo  $user['role']; ?>)" data-dismiss="modal">Close</button>
