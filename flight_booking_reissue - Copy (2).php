...
<?php
  ...
  //  print_r($bookCanusers);
    $childpsnger        = $bookCanusers[0]['child_count'];
        $arrival_location        = $bookCanusers[0]['arrival_location'];
    ...
    $return_dep_date      =   $objCancel->ReturnDepDate($bookingId,$userId,$arrival_location);
     $dep_date_returnTrip    =   $return_dep_date[0]['dep_date'];
                    ...
                    <tbody>
                        ...
                        foreach ($bookCanusers as $key => $val) {
                            ...
                            if(isset($_POST['airport'])) {
                                ...
                                $dep_location = $resultBooking[0]['dep_location']; // Use the default value from the database
                            }
                    ...
                    <!-- form-->
                        ...
                        <div class="srch-fld">
                            <div class="search-box on form-row">
                                <div class="col-12 mb-3">
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <div class="d-flex align-items-center chkbx ml-3">
                                            <input type="checkbox" name="selected-flights" value="<?php echo $resultBooking[0]['flight_no']?>" id="flight-number">
                                            <label class="mb-0" for="flight-number"><span class="chk-txt fs-13 fw-400">Departure Flight N0-<?php echo $resultBooking[0]['flight_no']?></span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-2">
                                    <input type="hidden" id="airport-input-reissue-value" value="<?php echo $dep_location; ?>"> 
                                    <input type="text" id="airport-input-reissue" name="airport" class="form-control" placeholder="Departing From"  value="<?php echo $dep_location; ?>">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <input type="hidden" id="arrivalairport-input-reissue-value" value="<?php echo $arrivalairport; ?>">

                                    <input type="text" id="arrivalairport-input-reissue" name="arrivalairport" class="form-control" placeholder="Going To" value="<?php echo $arrivalairport; ?>">
                                ...
                                <?php if(trim($resultBooking[0]['air_trip_type'])!='OneWay'){ //expecting return only
                                    $airTripTypests = 1;   
                                    ?>
                              <!--  <div class="col-md-2 mb-2">
                                ...
                                <!-- reverse the dep and arrv locn -->
                                <div class="col-md-3 mb-2">
                                    <input type="hidden" id="airport-input-reissue-value_return" value="<?php  echo $arrival_location;  ?>">
                                    <input type="text" id="airport-input-reissue_return" name="airport_return_dep" class="form-control" placeholder="Departing From">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <input type="hidden" id="arrivalairport-input-reissue-value_return" value="<?php  echo $resultBooking[0]['dep_location']; ?>">

                                    <input type="text" id="arrivalairport-input-reissue_return" name="arrivalairport_return" class="form-control" placeholder="Going To">

                                </div>
                                <div class="col-md-2 mb-2">
                                    <!-- <input type="text" class="form-control" id="from" name="from"> -->
                                    <input type="text" class="form-control" id="from-reisue" name="from-reissue_return" value=<?php echo $dep_date_returnTrip; ?>>
                                    <!-- <span class="icon">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path id="Vector" d="M3.25 0C2.38805 0 1.5614 0.34241 0.951903 0.951903C0.34241 1.5614 0 2.38805 0 3.25V14.75C0 15.612 0.34241 16.4386 0.951903 17.0481C1.5614 17.6576 2.38805 18 3.25 18H14.75C15.612 18 16.4386 17.6576 17.0481 17.0481C17.6576 16.4386 18 15.612 18 14.75V3.25C18 2.38805 17.6576 1.5614 17.0481 0.951903C16.4386 0.34241 15.612 0 14.75 0H3.
                                         <input type="hidden"  name="allow_child" id="allowchildP" value="<?php echo var_export($allow_child); ?>">
                                         <input type="hidden" name="air_trip_Type" id="air_trip_Type" value="<?php echo $airTripTypests; ?>">

                                    <input type="submit" name="go" class="btn btn-typ1 w-100 form-control" value="Search" id="search">
...
<script> 
/*
    function reissuequote_apicall(dep_location, arrival_airport,selectedPassengers){
         alert(dep_location);
         alert(arrival_airport);
           var allow_child = document.getElementById("allowchildP").value;
           var mfreNum = document.getElementById("precancelValue").value;
           var bookingId = document.getElementById("bookingId").value;
           var userId = document.getElementById("USerid").value;
           var air_trip_Type = document.getElementById("air_trip_Type").value;

          

             var dep_loc = document.getElementById("airport-input-reissue").value;
             var arrv_loc = document.getElementById("arrivalairport-input-reissue-value").value;
             var dep_date = document.getElementById("from-reisue").value;
             
             var airline_code = document.getElementById("airline-reissue-value").value;
             var selectedCabinPreference = document.getElementById("cabin-preference").value;
             var checkboxElement = document.getElementById("flight-number");
            checkboxElement.addEventListener("change", function() {
                if (this.checked) {
                    var checkedValue = this.value;
                     alert(checkedValue);return false;
                    console.log("Checkbox is checked. Value: " + checkedValue);
                    // Perform actions with the checked value
                } else {
          ...
          //  alert(dep_date);
            // alert(arrv_loc);
            // alert(dep_date_to);return false;
            if(air_trip_Type ===1){
                var dep_loc_return = document.getElementById("airport-input-reissue-value").value;
             var arrv_loc_return = document.getElementById("arrivalairport-input-reissue-value").value;
             var dep_date_to = document.getElementById("to").value;
             }
              alert(arrv_loc);
           //************************************ */
    ...
    //   alert(jsonString); return false;// This will display the contents of selectedPassengers as a JSON string
       $.ajax({
                url: 'reissue_ticket.php',
                type: 'POST',
                 data: { mfreNum: mfreNum,bookingId: bookingId,userId: userId,allow_child: allow_child,air_trip_Type: air_trip_Type,originDestinations: originDestinations,passengers: selectedPassengers },               
        ...
        if (responseData.status === 'success') {
            ...
            const successMessage = responseData.message;
                   ...
                   $('#TicketinprocessErr').modal('show');
                    $('#TicketinMessageErr').html(successMessage);
              ...
              $(this).parents('.modal').modal('hide');
               window.location.href = "index.php";
                ...
                // const cancel_booking_Id = responseData.cancel_booking_Id; 
                  ...
                  $.ajax({
                    url: 'search_Reissue_getExchange.php', // Replace 'third_api_url' with the URL of your third API
...
//===============================
    ...
    $(document).ready(function() {
       ...
       $("#flight-search_reissue").on("submit", function(event) {
        event.preventDefault(); // Prevent the form from submitting normally
        
        const formData = $(this).serialize(); // Serialize the form data
                     
      const selectedPassengers = getSelectedPassengers();       
        // $("#flight-search_reissue").submit();
        // alert("yyyy");return false;
      //=====================
       $.ajax({
            type: "POST",
            url: "reissue_ticket.php", // Adjust the URL to your PHP script
            data: { formData: formData,selectedPassengers: selectedPassengers },            
            success: function(response) {
               alert(response);return false;

                // Process the response (response contains the data sent by the server)
