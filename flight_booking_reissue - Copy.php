...
<?php
    ...
    $lastRecord = $resultBooking[count($resultBooking) - 1];
       ...
       echo "<pre/>"; print_r($resultBooking);
                    ...
                    -->
                        <div class="mb-3">
                            <h6 class="text-left fw-700">Do you want to change your journey?</h6>
                                ...
                                <form class="" id="flight-search" method="post" action="flight_booking_reissue.php">
                        ...
                        <div class="srch-fld">
                            <div class="search-box on form-row">
                                ...
                                <div class="col-md-2">
                                         ...
                                         <input type="hidden" id="allowchildP" value="<?php echo var_export($allow_child); ?>">
...
<script> 
    function reissuequote_apicall(selectedPassengers){
           ...
           var userId = document.getElementById("USerid").value;
             ...
             var dep_loc = document.getElementById("airport-input-reissue-value").value;
    ...
    //   alert(jsonString); return false;// This will display the contents of selectedPassengers as a JSON string
       $.ajax({
                ...
                type: 'POST',
                 data: { mfreNum: mfreNum,bookingId: bookingId,userId: userId,allow_child: allow_child,originDestinations: originDestinations,passengers: selectedPassengers },               
