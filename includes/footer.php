  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary close" data-dismiss="modal" id="closeButton1" >Close</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-lg-0 mb-md-5">
                    <ul class="footer-links">
                        ...
                        <li class="link-item"><a href="">Singapore Tours</a></li>
                        <li class="link-item"><a href="">Dubai Visa</a></li>
                        <li class="link-item"><a href="">Dubai Visa Extension</a></li>
                        <li class="link-item"><a href="">Kuala Lumpur Tours</a></li>
                        <li class="link-item"><a href="">Dubai Packages</a></li>
                        <li class="link-item"><a href="">Canada Visa</a></li>
                        <li class="link-item"><a href="">Upcoming Tours</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0 mb-md-5">
                    <ul class="footer-links">
                        <li class="link-title">Best Selling Tours</li>
                        <li class="link-item"><a href="">Evening Desert Safari</a></li>
                        <li class="link-item"><a href="">Abu Dhabi City Tour</a></li>
                        <li class="link-item"><a href="">Dubai Burj Khalifa</a></li>
                        <li class="link-item"><a href="">Global Village Dubai</a></li>
                        <li class="link-item"><a href="">Atlantis Aquaventure</a></li>
                        <li class="link-item"><a href="">Dubai Desert Safari with Dune Bashing</a></li>
...
<script>
    ...
    function showPosition(position) {
        ...
        const opencageApiKey = '4cbe89a6ae61485ba3462f8b3c53a5b5'; // Replace with your actual OpenCage API key
        const opencageApiURL = `https://api.opencagedata.com/geocode/v1/json?key=${opencageApiKey}&q=${latitude}+${longitude}`;
        ...
        fetch(opencageApiURL)
            ...
            .then(data => {
                ...
                // Check if the API response includes the expected data
                if (data.results && data.results.length > 0) {
                    const components = data.results[0].components;
                    const userCity = components.city || components.village || components.town;

                    const userCityElement = document.createElement("li");
                    userCityElement.textContent = `Location: ${userCity || 'Unknown Location'}`;

                    // Display the current date, user's city, and local time of departure city
                    const dynamicInfo = document.getElementById("dynamicInfo");
                    dynamicInfo.innerHTML = `<li>${formattedDate}</li>`;
                    dynamicInfo.appendChild(userCityElement);

                    // Display Local Time of Departure City
                    const timezone = data.results[0].annotations.timezone.name;
                    const departureCityTime = new Date().toLocaleTimeString('en-US', { timeZone: timezone });
                    const departureTimeElement = document.createElement("li");
                    departureTimeElement.textContent = `Local Time: ${departureCityTime}`;
                    dynamicInfo.appendChild(departureTimeElement);
                } else {
