...
if(isset($fsCode)) {
                  ...
                  $logReQ =   print_r($requestData, true);
                    ...
                    $objBook->_writeLog('Request Received\n'.$logReQ,'revalidate.txt');
                            $objBook->_writeLog('fsCode Received for MF:\nfsc'.$fsCode,'revalidate.txt');
                             // $objBook->_writeLog('userId is '.$userId. 'BOOKING STATUS IS '.$responseData['Data']['Status'],'revalidate.txt');
                             // $objBook->_writeLog('Booking ID is '.$bookingID,'revalidate.txt');
 ...
 //============ END log write for book API ==========  
    $pricedItineraries = $responseData['Data']['PricedItineraries'];
     ...
     $responseData['Data']['Errors'][0]['Message']   = "No valid Results ,Please search Again"; 
         
}// else of no fsc close
...
?>
    <div class=" container">
        <?php echo  $responseData['Data']['Errors'][0]['Message'] ; ?>
    </div>
...
<?php
    ...
    $responseData['Data']['Errors'][0]['Message']   = "No valid Results ,Please search Again"; //data getting ,success 1 and no errors but empty itinery info
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex">
                                            Total Price: <strong class="light-blue-txt">
                                                ...
                                                // echo 'helo';
                                                // echo $pricinfInfo['TotalFare']['Amount'];
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <li class="d-flex justify-content-between bg-b1b1b1 p-1 mt-1">
                                                            <strong class="fw-600">Total Fare</strong><strong>&#36;
                                                                ...
                                                                // echo $pricedItinerary['AirItineraryPricingInfo']['ItinTotalFare']['TotalFare']['Amount'];
                                                                echo number_format(round($totalFareAPI + $markupPercentage, 2), 2);
                                                                ?>
                                                            </strong>
                                                        </li>
                                                        </ul>
                    ...
                    <div class="col-12">
                        ...
                        <form action="" method="post" id="booking-submit" class="form-row justify-content-center pt-lg-4 pb-lg-4 pt-3 pb-3 px-3">
                            <div class="col-lg-10">
                                ...
                                <!-- <input type="hidden" name="paxNameCharacterLimit" value="<?php //echo $_SESSION['paxNameCharacterLimit'] ?>"> -->
...
<script>
    ...
    /**********************************************/
        ...
        // JavaScript code to open the modal after the page loads
        $(document).ready(function() {
           ...
           /* if(empty($responseData['Data']['IsValid'])) {
            // if ($responseData['Data']['IsValid']) {
                echo '$("#errorMessage").text("' . $responseData['Data']['IsValidReason'] . '");';
                echo "$('#errorModal').modal('show');";
                echo '$(".close").click(function(){ $(this).parents(".modal").modal("hide"); });';
            } commented on 23May since no such isvalidreason param from response data loading empty popup */
