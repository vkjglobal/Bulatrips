            ...
            <div id="loginbookflight" style="display: none;">
                ...
                <!-- <div id="logindiv" style="display: none;"> 
                        <div class="mb-4 fw-300">
                            ...
                            <strong class="fw-500"><?php echo $_SESSION['email']; ?></strong> 
                        </div>
                        <button id="travellerContinueButton" class="btn btn-typ3 fs-15 fw-600 pl-4 pr-4" data-value="<?php echo $pricedItinerary['AirItineraryPricingInfo']['FareSourceCode'] ?>" data-adult="<?php echo $_SESSION['adultCount'] ?>" data-child="<?php echo $_SESSION['childCount'] ?>" data-infant="<?php echo $_SESSION['infantCount'] ?>">CONTINUE</button>
                    </div> -->
