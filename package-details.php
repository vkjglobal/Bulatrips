            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                    <div class="row justify-content-between">
                        <div class="col-md-8 package-name-sec">
                            <h1 class="dark-blue-txt fw-700">Abu Dhabi Fully Loaded - Buy 
                                1 Get 1 Free - Winter</h1>
                                <ul class="d-flex justify-content-end justify-content-md-start">
                                    <li><span class="star-rate-blue"></span></li>
                                    <li><span class="star-rate-blue"></span></li>
                                    <li><span class="star-rate-blue"></span></li>
                                    <li><span class="star-rate-blue"></span></li>
                                    <li><span class="star-rate-ash"></span></li>
                                </ul>
                        </div>
                        <div class="col-md-4 package-price-sec">
                            <strike class="d-block text-center fs-16 fw-400 ash-txt">Rs. <span>1 07 495</span></strike>
                            <div class="text-center pckg-price">
                                <h4 class="fw-700 light-blue-txt">Rs. <span>53747</span></h4> 
                                <div class="fs-16 fw-400 ash-txt">Starting price per adult</div>
                            </div>
                        </div>
                    </div>
                    <hr class="d-none d-lg-block" style="border-color: #888888; margin-bottom:0;">
                </div>
                <div class="col-xl-3 col-lg-4 d-flex align-items-center justify-content-center">
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-center">
                            <button class="btn border-radius-100 fs-18 fw-600 white-txt btn-typ1 pl-5 pr-5 uppercase-txt">BOOK NOW</button>
                        </div> 
                    </div>
                </div>
            </div>
            <hr class="d-block d-lg-none" style="border-color: #888888; margin-bottom:0;">
            <div class="row">
                <div class="col-xl-9 col-lg-8 pt-3 mb-4">
                    <ul class="book-dtls-desc">
                        <li class="d-flex align-items-center">
                            ...
                            <strong class="fs-15 fw-300 ml-2">7D/6N</strong>
                        </li>
                        <li class="d-flex align-items-center">
                            <span class="d-flex align-items-center">
                            ...
                            <strong class="fs-15 fw-300 ml-2">pax: 10</strong>
                        </li>
                        <li class="d-flex align-items-center">
                            <span class="d-flex align-items-center">
                            ...
                            <strong class="fs-15 fw-300 ml-2">Dubai</strong>
                        </li>
                    </ul>
                    ...
                    <div class="detail-txt-info">
                        <strong class="d-block fs-22 fw-700 mb-3">OVERVIEW:</strong>
                        <p class="fs-15 fw-400 mb-3">
                        ...
                        <strong class="d-block fs-22 fw-700 mb-3">INCLUDE & EXCLUDE:</strong>
                        <div class="row">
                            <div class="col-lg-8">
                                <ul class="row">
                                    <li class="col-md-6">Specialized bilingual guide</li>
                                    <li class="col-md-6">Guide Service Fee</li>
                                    <li class="col-md-6">Private Transport</li>
                                    <li class="col-md-6">Room Service Fees</li>
                                    <li class="col-md-6">Entrance Fees</li>
                                    <li class="col-md-6">Driver Service Fee</li>
                                    <li class="col-md-6">Breakfast And Lunch Box</li>
                                    <li class="col-md-6">Any Private Expenses</li>
                                </ul>
                            </div>
                        </div>
                        <strong class="d-block fs-22 fw-700 mb-3">INTINERARY:</strong>
                        <p class="fs-15 fw-400 mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <ul class="row">
                                    <li class="col-12">DAY 1 Departure at the airport and arrival at the hotel</li>
                                    <li class="col-12">DAY 2 Visit the main museums and lunch included</li>
                                    <li class="col-12">DAY 3 Excursion in the natural oasis and picnic</li>
                                    <li class="col-12">Specialized bilingual guide</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 details-sidebar">
                    <form action="" class="right-blue-box light-blue-bg border-radius-25 form-group">
                        <strong class="title-typ1 d-block text-center fw-700 white-txt mb-3">ENQUIRY</strong>
                        <p class="text-center fw-400 white-txt">Malesuada incidunt excepturi proident quo eros? Sinterdum praesent magnis, eius cumque.
                        </p>
                        <div class="form-row">
                            <div class="col-12 mb-2">
                                <input type="text" placeholder="Name" class="form-control fw-500 border-radius-100">
                            </div>
                            <div class="col-12 mb-2">
                                <input type="email" placeholder="Email" class="form-control fw-500 border-radius-100">
                            </div>
                            <div class="col-lg-6 mb-3 calndr-icon text-center">
                                <label for="" class="fw-500 white-txt">Checkin Date</label>
                                <input type="text" class="form-control fw-500 border-radius-100" id="from" name="from">
                                <!-- <span class="icon">
                            ...
                            <div class="col-lg-6 mb-3 calndr-icon text-center">
                                <label for="" class="fw-500 white-txt">Checkout Date</label>
                                <input type="text" class="form-control fw-500 border-radius-100" id="to" name="to">
                                <!-- <span class="icon">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path id="Vector" d="M3.25 0C2.38805 0 1.5614 0.34241 0.951903 0.951903C0.34241 1.5614 0 2.38805 0 3.25V14.75C0 15.612 0.34241 16.4386 0.951903 17.0481C1.5614 17.6576 2.38805 18 3.25 18H14.75C15.612 18 16.4386 17.6576 17.0481 17.0481C17.6576 16.4386 18 15.612 18 14.75V3.25C18 2.38805 17.6576 1.5614 17.0481 0.951903C16.4386 0.34241 15.612 0 14.75 0H3.25ZM1.5 5.5H16.5V14.75C16.5 15.2141 16.3156 15.6592 15.9874 15.9874C15.6592 16.3156 15.2141 16.5 14.75 16.5H3.25C2.78587 16.5 2.34075 16.3156 2.01256 15.9874C1.68437 15.6592 1.5 15.2141 1.5 14.75V5.5ZM13.25 11.5C12.9185 11.5 12.6005 11.6317 12.3661 11.8661C12.1317 12.1005 12 12.4185 12 12.75C12 13.0815 12.1317 13.3995 12.3661 13.6339C12.6005 13.8683 12.9185 14 13.25 14C13.5815 14 13.8995 13.8683 14.1339 13.6339C14.3683 13.3995 14.5 13.0815 14.5 12.75C14.5 12.4185 14.3683 12.1005 14.1339 11.8661C13.8995 11.6317 13.5815 11.5 13.25 11.5V11.5ZM9 11.5C8.66848 11.5 8.35054 11.6317 8.11612 11.8661C7.8817 12.1005 7.75 12.4185 7.75 12.75C7.75 13.0815 7.8817 13.3995 8.11612 13.6339C8.35054 13.8683 8.66848 14 9 14C9.33152 14 9.64946 13.8683 9.88388 13.6339C10.1183 13.3995 10.25 13.0815 10.25 12.75C10.25 12.4185 10.1183 12.1005 9.88388 11.8661C9.64946 11.6317 9.33152 11.5 9 11.5V11.5ZM13.25 7.5C12.9185 7.5 12.6005 7.6317 12.3661 7.86612C12.1317 8.10054 12 8.41848 12 8.75C12 9.08152 12.1317 9.39946 12.3661 9.63388C12.6005 9.8683 12.9185 10 13.25 10C13.5815 10 13.8995 9.8683 14.1339 9.63388C14.3683 9.39946 14.5 9.08152 14.5 8.75C14.5 8.41848 14.3683 8.10054 14.1339 7.86612C13.8995 7.6317 13.5815 7.5 13.25 7.5ZM9 7.5C8.66848 7.5 8.35054 7.6317 8.11612 7.86612C7.8817 8.10054 7.75 8.41848 7.75 8.75C7.75 9.08152 7.8817 9.39946 8.11612 9.63388C8.35054 9.8683 8.66848 10 9 10C9.33152 10 9.64946 9.8683 9.88388 9.63388C10.1183 9.39946 10.25 9.08152 10.25 8.75C10.25 8.41848 10.1183 8.10054 9.88388 7.86612C9.64946 7.6317 9.33152 7.5 9 7.5V7.5ZM4.75 7.5C4.41848 7.5 4.10054 7.6317 3.86612 7.86612C3.6317 8.10054 3.5 8.41848 3.5 8.75C3.5 9.08152 3.6317 9.39946 3.86612 9.63388C4.10054 9.8683 4.41848 10 4.75 10C5.08152 10 5.39946 9.8683 5.63388 9.63388C5.8683 9.39946 6 9.08152 6 8.75C6 8.41848 5.8683 8.10054 5.63388 7.86612C5.39946 7.6317 5.08152 7.5 4.75 7.5ZM3.25 1.5H14.75C15.716 1.5 16.5 2.284 16.5 3.25V4H1.5V3.25C1.5 2.284 2.284 1.5 3.25 1.5Z" fill="#6D759C"/>
                                    </svg>    
                            ...
                            <div class="col-12 mb-4">
                                <input type="submit" value="send" class="btn btn-typ2 border-radius-100 w-100 uppercase-txt">
                            </div>
                        </div>
                        <p class="text-center fw-500 white-txt">Thank you for your message. 
                            It has been sent.</p>
                    </form>
                    <div class="related-images-slider-wrp">
                        <strong class="title-typ1 d-block text-center fw-700 mb-2">RELATED IMAGES</strong>
                        <p class="fs-15 fw-400 text-center mb-1">Malesuada incidunt excepturi proident quo eros? Sinterdum praesent magnis, eius cumque.</p>
                        <div class="owl-carousel related-images owl-theme owl-loaded">
                    ...
                    <div class="more-pckg-lnks border-radius-25">
                        <div class="white-bg border-radius-100 uppercase-txt text-center fs-18 fw-500 mb-4 p-1">MORE PACKAGES</div>
                        <ul>
