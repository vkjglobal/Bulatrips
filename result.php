                    ...
                    ?>
                        <div class="col-12 light-border mb-3">
                            <ul class="flight-list">
                                ...
                                // $totalStop = 0;
                                $totalstop = 0; //Totalstops for TO Trip
                               // echo $totalstop."SSSSSSSSSSSSSs";
                                foreach ($pricedItinerary['OriginDestinations'] as $originDestination) {
                                    if ($originDestination['LegIndicator'] == 0) {
                                        $totalstop = $totalstop + 1;
                                       // echo "IFFFFFFFFFFFFFFFFFFFFFFFFFFFF".$totalstop;
                                    }
                                   // echo "INSIDEDDDDDDDDDDDDDDDDD foreach".$totalstop;
                                }
                                $totalstop = $totalstop - 1;
                               // echo $totalstop."YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY";
                               ...
                               //echo "<pre/>";print_r($flightSegmentList);
                                ...
                                //echo $totalReturnStop. "PPPPPPPPPPPPPP";
                                ...
                                <hr>
                                <li class="contentbar">
                                    <ul class="form-row mb-3 p-4 rounded shadow-sm">
                                        <?php


                                        ?>
                                        <li data-th="Airline" class="main-dtls col-md-2 d-flex flex-column align-items-center justify-content-center mb-2">
                                            <small class="text-muted">Airline</small>
                                            <span class="airImg airline-<?php echo $pricedItinerary['ValidatingCarrier']; ?> mb-2"></span>
                                        </li>
                                         <!-- Departure -->
                                        <li data-th="Depart" class="main-dtls col-md-1 d-flex flex-column text-center mb-2">
                                            <small class="text-muted">Departure</small>
                                            <div class="font-weight-bold"><?php echo $segmentReturn['DepartureAirportLocationCode']; ?></div>

                                            <?php
                                                $datetime = $segment['DepartureDateTime'];
                                                list($date, $time) = explode("T", $datetime);
                                                 ?>
                                            <div><?php echo date("d F Y", strtotime($date)); ?></div>
                                            <div><?php echo $time; ?></div>
                                        </li>
                                        <!-- Stops -->
                                        <li data-th="Stops" class="main-dtls col-md-2 d-flex flex-column text-center mb-2">
                                        ...
                                        <!-- Arrival -->
                                        <li data-th="Arrive" class="main-dtls col-md-2 d-flex flex-column text-center mb-2">
                                            <small class="text-muted">Arrival</small>
                                            <div class="font-weight-bold"><?php echo $segmentReturnArrival['ArrivalAirportLocationCode']; ?></div>
                                            <?php
                                                if ($totalstop > 0) {
                                        ...
                                        <li data-th="Duration" class="main-dtls col-md-3 d-flex flex-column text-center mb-2">
                                        ...
                                        <li data-th="Price" class="main-dtls col-md-2 d-flex flex-column align-items-md-center mb-md-0 mb-2">
                                            ...
                                            $totalInfantfare = 0;
                                            // echo '<pre/>';
                                            // print_r($fareListRef['PassengerFare']);
                                            ...
                                            <span class="text-success font-weight-bold">&#36; <strong><?php echo number_format(round($totalAdultfare + $totalChildfare + $totalInfantfare + $markupPercentage, 2), 2); ?></strong></span>
                                        ...
                                        <ul class="form-row mb-lg-5 mb-3">
                                            ...
                                            <li data-th="Depart" class="main-dtls col-md-1 d-flex flex-column text-center mb-2">
                                                ...
                                                <div><?php 
                                                    ...
                                                    list($date, $time) = explode("T", $datetime);
                                                    echo date("d F Y", strtotime($date)); ?></div>
                                                <div><?php echo $time; ?></div>
                                            </li>
                                            <li data-th="Stops" class="main-dtls col-md-2 d-flex flex-column text-center mb-2">
                                                <small class="text-muted">Stops</small>
                                                ...
                                                <div class="d-flex justify-content-md-between flex-md-row flex-column fs-15 fw-300 mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        if ($totalstop > 0) {
                                                            ...
                                                            // Step 1: Convert datetime strings to DateTime objects
                                                            $datetime1 =    DateTime::createFromFormat("Y-m-d\TH:i:s", $datetime1_str, $timezone);                                                            
                                                            $datetime2 =    DateTime::createFromFormat("Y-m-d\TH:i:s", $datetime2_str, $timezone);
                                                            
                                                           

                                                            // Step 2: Calculate the time difference between the two DateTime objects
                                                            $time_difference = $datetime2->getTimestamp() - $datetime1->getTimestamp();

                                                                $hours = floor($time_difference / 3600); // 3600 seconds in an hour
                                                                $minutes = floor(($time_difference % 3600) / 60); // Remaining seconds converted to minutes
                                                               // echo "MM". $hours . " h " . $minutes . " m ";
                                                        } else {
                                                                $returnText =   "";
                                                            $datetime1_str = $segment['DepartureDateTime'];
                                                            $datetime2_str = $segment['ArrivalDateTime'];
                                                                ...
                                                                <div class="d-flex row justify-content-between">
                                                                    ...
                                                                    <div class="col-md-2 mb-md-0 mb-2">
                                                                        <div class="d-flex flex-column align-items-center">
                                                                           ...
                                                                           // echo minutesToHoursMinutes($minutes); 
                                                            ...
                                                            <li>
                                                                ...
                                                                <!-- Start of cancelation/REfund Penalty fee ---- -->
                                                                    <li class="d-flex justify-content-between p-1 mt-1">
                                                                        ...
                                                                        ///// print_r($penaltyListRef);
                                                                        // echo $roleId."XXXXXXXXXXXXXXXXXXXXXX";
                                                                        // print_r($penalityList);
                                                                        //======================================
                                                                                   ...
                                                                                   // echo $val['RefundPenaltyAmount']."LLLLLLLLL".$markupPenaltyPercentage."TOTAL:".($val['RefundPenaltyAmount']+$markupPenaltyPercentage);
                                                                                    ...
                                                                                    <?php
                                                                                           ...
                                                                                           ?>
                                                                                            ...
                                                                                            // echo "<pre/>";print_r($markupPenaltyInfo);
                                                                                        ?>
