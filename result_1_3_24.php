                        ...
                        <div class="col-12 light-border mb-3">
                            <ul class="flight-list">
                                ...
                                if ($totalstop > 0) {
                                    ...
                                    // print_r( $originDestinationsstops);
                                    // print_r( $segmentstop);
                                    // print_r( $arrival);
                                }
                                        ...
                                        <li data-th="Duration" class="main-dtls col-md-3 d-flex flex-column justify-content-between duration-dtls fs-13 mb-md-0 mb-2">
                                            <div>
                                                ...
                                                if ($totalstop > 0) {
                                                    ...
                                                    // $date1 = DateTime::createFromFormat("Y-m-d\TH:i:s", $segment['DepartureDateTime']);
                                                    // $date2 = DateTime::createFromFormat("Y-m-d\TH:i:s", $artime);
                                                    ...
                                                    // $date1 = DateTime::createFromFormat("Y-m-d\TH:i:s", $segment['DepartureDateTime']);
                                                    // $date2 = DateTime::createFromFormat("Y-m-d\TH:i:s", $segment['ArrivalDateTime']);
                                                    // // $date2 = DateTime::createFromFormat("Y-m-d\TH:i:s", $artime);
                                                    // $interval =  $date1->diff($date2);
                                            ...
                                            <div class="tab-pane p-lg-5 pt-5 p-3 pane1">
                                                ...
                                                <div class="d-flex justify-content-md-between flex-md-row flex-column fs-15 fw-300 mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        echo $hours . " h  " . $minutes . " m";echo'hi';
                                                                ...
                                                                <div class="d-flex row justify-content-between">
                                                                    ...
                                                                    <div class="col-md-2 mb-md-0 mb-2">
                                                                        <div class="d-flex flex-column align-items-center">
                                                                            ...
                                                                            // $hours = floor($minutes / 60);
                                                                            // $remainingMinutes = $minutes % 60;
                                                                            $date1 = DateTime::createFromFormat("Y-m-d\TH:i:s", $originSegment['DepartureDateTime']);
                                                                            $date2 = DateTime::createFromFormat("Y-m-d\TH:i:s", $originSegment['ArrivalDateTime']);
                                                                            $interval =  $date1->diff($date2);
                                                            ...
                                                            <li>
                                                                <ul>
                                                                    <li class="d-flex justify-content-between p-1 mt-1">
                                                                        ...
                                                                        $count_passenger = count($penalityList);
                                                                        // echo $count_passenger;

                                                                        //flight cancel fee for individual person
                                                                        //date change fee for individual person
                                                                        if($count_passenger == 1){
                                                                            $adult_cancel = $penalityList[0]['RefundPenaltyAmount'];
                                                                            $adult_dateChange = $penalityList[0]['ChangePenaltyAmount'];
                                                                        }
                                                                        if($count_passenger == 2){
                                                                            $adult_cancel = $penalityList[0]['RefundPenaltyAmount'];
                                                                            $adult_dateChange = $penalityList[0]['ChangePenaltyAmount'];

                                                                            $child_cancel = $penalityList[1]['RefundPenaltyAmount'];
                                                                            $child_dateChange = $penalityList[1]['ChangePenaltyAmount'];
                                                                        }
                                                                        if($count_passenger == 3){
                                                                            $adult_cancel = $penalityList[0]['RefundPenaltyAmount'];
                                                                            $adult_dateChange = $penalityList[0]['ChangePenaltyAmount'];
                                                                            ...
                                                                            $infant_cancel = $penalityList[2]['RefundPenaltyAmount'];
                                                                            $infant_dateChange = $penalityList[2]['ChangePenaltyAmount'];
                                                                        }
                                                                       
                                                                        //get markeup of end user from marktable and calculate the % and this % add to total fare
                                                                        // $penality_markup = $conn->prepare("SELECT * FROM markup_commission WHERE role_id = :role_id AND status = '1'");
                                                                        ...
                                                                        // } else {
                                                                        //     $stmtmarkup->execute(array('role_id' => 1));
                                                                        //     $penalityFee = $stmtmarkup->fetch(PDO::FETCH_ASSOC);
                                                                        // }
                                                                        // echo 'helo';
                                                                        // print_r($penalityFee);

                                                                        $penaltyFee = '3';//assuming markupfee for cancelation value 3
                                                                        $penaltyDatefee = '5';//assuming markupfee for date change value 5
                                                                        // Convert string values to numbers
                                                                        $penaltyFeeNumeric = floatval($penaltyFee);
                                                                        $penaltyDatefeeNumeric = floatval($penaltyDateFee)
                                                                        ?>
                                                                    </li>
                                                                    <li class="text-left">
                                                                        <table class="w-100">
                                                                            <!-- <tr class="bdr">
                                                                                ...
                                                                                <td class="p-1"><?php echo $penaltyListRef['Penaltydetails'][0]['Currency'] ?> <?php echo $penaltyListRef['Penaltydetails'][0]['RefundPenaltyAmount'] ?></td>
                                                                            </tr> -->
                                                                            <tr class="bdr" id="firstRow">
                                                                                ...
                                                                                <td>
                                                                                    <?php 
                                                                                    if($count_passenger <= 3){
                                                                                        foreach( $penalityList as $pasType ) { 
                                                                                            if($pasType['PaxType'] == 'ADT') {
                                                                                                if($adult_cancel == 0){
                                                                                                    $adult_cancel_fee = $adult_cancel;
                                                                                                }else{
                                                                                                // Convert string values to numbers
                                                                                                $adult_cancelNumeric = floatval($adult_cancel);

                                                                                                // Perform the calculation
                                                                                                $adult_cancel_fee = ($penaltyFeeNumeric / 100) * $adult_cancelNumeric;
                                                                                                }
                                                                                            ?>
                                                                                                Adult : <?php echo $pasType['Currency']." ".$adult_cancel_fee; ?><br>
                                                                                    <?php   } 
                                                                                            if($pasType['PaxType'] == 'CHD'){ 
                                                                                                if($child_cancel == 0){
                                                                                                    $child_cancel_fee = $child_cancel;
                                                                                                }else{
                                                                                                $child_cancelNumeric = 0;
                                                                                                // Convert string values to numbers

                                                                                                $child_cancelNumeric += floatval($child_cancel); 
                                                                                                // Perform the calculation
                                                                                                $child_cancel_fee = ($penaltyFeeNumeric / 100) * $child_cancelNumeric;
                                                                                                }
                                                                                                ?>
                                                                                                Children :  <?php echo $pasType['Currency']." ".$child_cancel_fee; ?><br>
                                                                                    <?php   }
                                                                                            if($pasType['PaxType'] == 'INF'){ 
                                                                                                if($infant_cancel == 0){
                                                                                                    $infant_cancel_fee = $infant_cancel;
                                                                                                }else{
                                                                                                $infant_cancelNumeric = 0;
                                                                                                // Convert string values to numbers
                                                                                                $infant_cancelNumeric += floatval($infant_cancel); 
                                                                                                // Perform the calculation
                                                                                                $infant_cancel_fee = ($penaltyFeeNumeric / 100) * $infant_cancelNumeric;
                                                                                                }
                                                                                                ?>
                                                                                                Infant : <?php echo $pasType['Currency']." ".$infant_cancel_fee; ?>
                                                                                    <?php   } 
                                                                                        }
                                                                                    }
                                                                                    ?>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="text-left">
                                                                        <table class="w-100">
                                                                            <!-- <tr class="bdr">
                                                                                <td class="bg-f0f3f5 p-1" style="width: 40%;">Airline fee</td>
                                                                                <td class="p-1"><?php echo $penaltyListRef['Penaltydetails'][0]['Currency'] ?> <?php echo $penaltyListRef['Penaltydetails'][0]['ChangePenaltyAmount'] ?></td>
                                                                            </tr> -->
                                                                            <tr class="bdr">
                                                                                <td class="bg-f0f3f5 p-1" style="width: 40%;">Airline fee</td>
                                                                                <!-- <td class="p-1"><?php echo $penaltyListRef['Penaltydetails'][0]['Currency']; ?> <?php echo $penaltyListRef['Penaltydetails'][0]['ChangePenaltyAmount'] ?></td> -->
                                                                                <td>
                                                                                    ...
                                                                                    if($count_passenger <= 3){
                                                                                        foreach( $penalityList as $pasType ) { 
                                                                                            if($pasType['PaxType'] == 'ADT') {
                                                                                                if($adult_dateChange == 0){
                                                                                                    $adult_dateChange_fee = $adult_dateChange;
                                                                                                }else {
                                                                                                    $adult_cancelNumeric = 0;
                                                                                                    // Convert string values to numbers
                                                                                                    $adult_cancelNumeric += floatval($adult_dateChange); 
                                                                                                    // Perform the calculation
                                                                                                    $adult_dateChange_fee = ($penaltyDatefeeNumeric / 100) * $adult_cancelNumeric;
                                                                                                    } ?>
                                                                                                Adult : <?php echo $pasType['Currency']." ".$adult_dateChange_fee; ?><br>
                                                                                    <?php   } 
                                                                                            if($pasType['PaxType'] == 'CHD'){ 
                                                                                                if($child_dateChange == 0){
                                                                                                    $child_dateChange_fee = $child_dateChange;
                                                                                                }else {
                                                                                                    $child_cancelNumeric = 0;
                                                                                                    // Convert string values to numbers
                                                                                                    $child_cancelNumeric += floatval($child_dateChange); 
                                                                                                    // Perform the calculation
                                                                                                    $child_dateChange_fee = ($penaltyDatefeeNumeric / 100) * $child_cancelNumeric;
                                                                                                    } ?>
                                                                                                Children :  <?php echo $pasType['Currency']." ".$child_dateChange_fee; ?><br>
                                                                                    <?php   }
                                                                                            if($pasType['PaxType'] == 'INF'){ 
                                                                                                if($infant_dateChange == 0){
                                                                                                $infant_dateChange_fee = $infant_dateChange;
                                                                                            }else {
                                                                                                $infant_cancelNumeric = 0;
                                                                                                // Convert string values to numbers
                                                                                                $infant_cancelNumeric += floatval($infant_dateChange); 
                                                                                                // Perform the calculation
                                                                                                $infant_dateChange_fee = ($penaltyDatefeeNumeric / 100) * $infant_cancelNumeric;
                                                                                                } ?>
                                                                                                Infant : <?php echo $pasType['Currency']." ".$infant_dateChange_fee; ?>
                                                                                    <?php   } 
                                                                                        }
                                                                                    }
                                                                                    ?>
                                                                                    <!-- // Adult : <?php echo $penaltyListRef['Penaltydetails'][0]['Currency']." ".$adult_dateChange; ?><br> -->
                                                                                    <!-- // Children :  <?php echo $penaltyListRef['Penaltydetails'][1]['Currency']." ".$child_dateChange; ?><br> -->
                                                                                    <!-- // Infant : <?php echo $penaltyListRef['Penaltydetails'][2]['Currency']." ".$infant_dateChange; ?> -->
                                                                                </td>
                                                                            </tr>
                                                                            <!-- <tr class="bdr">
                                                                        <td class="bg-f0f3f5 p-1" style="width: 40%;">Thomas Cook Fee</td>
