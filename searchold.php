    ...
    <section class="midbar-wrapper-inner pt-3 pb-3">
        <div class="flight-search-midbar container">
            <div class="d-flex white-txt justify-content-center">
                Kochi To Dubai Return Flights (KCZ to DXB) Fri, 18 Nov - Sat, 26 Nov | 1 Adult Modify Search
            </div>
            <div class="row">
                <form class="flight-search col-12">
                    <span class="lbl">
                    ...
                    <div class="select-class-wrp">
                        <select name="cabin-preference" class="select-class" id="">
                    ...
                    <span class="person-select">
                        <label for="" class="select-lbl">Traveller <span class="count">1</span><span class="downarrow"></span></label>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="breadcrumbs">
                        ...
                        <li><a href="">Kochi to Dubai Return Flights</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            foreach ($pricedItineraries as $pricedItinerary) {
                                ...
                                $originDestinations = $pricedItinerary['OriginDestinations'][0];
                                    ...
                                    $onestop = false;
                                     ...
                                     if($pricedItinerary['OriginDestinations'][1]){
                                        $onestop = true;
                                ...
                                <li class="pt-4 contentbar">
                                    <ul class="form-row mb-lg-5 mb-3">
                                        ...
                                        <li data-th="Price" class="main-dtls col-md-2 d-flex flex-column align-items-md-center mb-md-0 mb-2">
                                            <div class="price-dtls mb-md-0 mb-2">USD <strong><?php echo $fareListRef['PassengerFare'][0]['TotalFare']; ?></strong></div>
                                                    ...
                                                    <ul class="col-lg-3 mb-3">
                                                        <div class="text-left">
                                                            <strong class="fw-500 d-block">
                                                                <?php
                                                              $stmtairline = $conn->prepare('SELECT * FROM airline WHERE code = :code');
                                                ...
                                                <?php
                                                    ...
                                                    <ul class="col-lg-3 mb-3">
                                                        <div class="text-left">
                                                            ...
                                                            Flight No - <?php echo $segment['OperatingFlightNumber']; ?>
                                                        </div>
                                                    </ul>
                                                    <div class="col-lg-7">
                                                        <div class="d-flex row justify-content-between">
                                                            <div class="col-md-5 mb-md-0 mb-2 text-md-left">
                                                                ...
                                                                // echo date("d F Y", strtotime($date));
                                                                ?>
                                                                <strong class="fw-500 d-block"><?php echo $segment['DepartureAirportLocationCode']."".$time ?></strong> 
                                                            ...
                                                            <div class="col-md-5 text-md-left">
                                                                <strong class="fw-500 d-block"><?php echo $segment['ArrivalAirportLocationCode']; ?>13:00 </strong>
                                                                Fri, 18 Nov, 2022 Tokyo International, Tokyo Haneda Terminal 1
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex row justify-content-between fs-15 fw-300 mb-4">
                                                    <ul class="col-lg-3 mb-3">
                                                        <div class="text-left">
                                                            ...
                                                            Flight No - <?php echo $segmentstop['OperatingFlightNumber']; ?>
                                                        </div>
                                                    </ul>
                                                    <div class="col-lg-7">
                                                        <div class="d-flex row justify-content-between">
                                                            <div class="col-md-5 mb-md-0 mb-2 text-md-left">
                                                                <strong class="fw-500 d-block"><?php echo $segmentstop['DepartureAirportLocationCode']; ?> 11:45</strong> 
                                                                Fri, 18 Nov, 2022 Kma, Kochi
                                                            </div>
                                                            <div class="col-md-2 mb-md-0 mb-2">
                                                                <div class="d-flex flex-column align-items-center">
                                                            ...
                                                            <div class="col-md-5 text-md-left">
                                                                <strong class="fw-500 d-block"><?php echo $segmentstop['ArrivalAirportLocationCode']; ?> 13:00 </strong>
                                                                Fri, 18 Nov, 2022 Tokyo International, Tokyo Haneda Terminal 1
                                                            </div>
                                                        </div>
                                                    </div>
