                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                       <img src="http://localhost:8080/travelsite/travelsitegit/travelsite-1/images/Bulatrips-logo.png" style="width:140px;">
                                    </td>
                                </tr>
                            </table>
                        </th>
                                    ...
                                    <td style="text-align: left;">
                                        <table style="width: 40%; border-spacing: 15px;">
                                            ...
                                            <tr>
                                                ...
                                                <td><strong><span style="display: inline-block; width: 50%;">$</span><span style="display: inline-block; width: 50%; text-align: right;">'.$total+$tripDetails['ClientMarkup']['Amount'].'</span></strong></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
$subject = "Flight Ticket";
    ...
    // (Optional) Adjust Dompdf configuration if needed
    $dompdf->setPaper('A4', 'portrait');

    $dompdf->render();
     $dompdf->output();
     $pdfcontent= $dompdf->output();
     if(ticketSendMail($toEmail, $subject, $messageData,$pdfcontent)){
        echo "success";
     }else{
        echo "error";
     }
