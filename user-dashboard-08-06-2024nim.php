                            ...
                            <div id="parent" class="d-flex flex-column">
                                ...
                                <div class="c box booking-incompleted">
                                    <table>
                                        ...
                                        $stmtbookingid = $conn->prepare('SELECT * FROM temp_booking WHERE user_id = :userid and booking_status = :bookingStatus and ticket_status = :ticketStatus');

                                        $stmtbookingid->execute(array('userid' => $id, 'bookingStatus' => "Booked", 'ticketStatus' => "Ticketed"));
                                        $bookingData = $stmtbookingid->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($bookingData as $bookingDatas) {
                                            $dateTime = new DateTime($bookingDatas['dep_date']);
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <?php if($user){ ?>
                                                <img src="uploads/profile/<?php echo $pimage; ?>" alt="profile img" width="60" height="60">
                                            <?php } ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="endusercity" id="endusercity" class="form-control" value="<?php echo $user['city']; ?>">
                                        </div>
                                        <div class="col-6 mb-3">
                            ...
                            <article class="sub-tabs-container mt-3">
                                <div class="row justify-content-between">
                                    <div class="col-md-5 mb-3">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <input type="password" name="user-current-password" id="user-current-password" class="form-control" placeholder="Enter Current Password">
                                                <span id="current-password-error" style="color:red;"></span>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <input type="password" name="user-new-password" id="user-new-password" class="form-control" placeholder="Enter New Password">
                                                <span id="new-password-error" style="color:red;"></span>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <input type="password" name="user-new-varify-password" id="user-new-varify-password" class="form-control" placeholder="Confirm New Password">
                                                <span id="verify-password-error" style="color:red;"></span>
                                            </div>
                                            <div class="col-12">
                                                <button type="submit" id="change-user-password" class="btn btn-typ3 pl-5 pr-5">SAVE</button>
